...
if(isset($_POST['student'])){
  ...
  header ("location: pending_view.php");
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Pending Students</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card">
              ...
              <form method="POST">
                <table class="table table-striped table-valign-middle">
                  ...
                  <tbody>
                    <?php
                      $resulted = mysqli_query($conn, "SELECT tbl_acc.id, tbl_section.section, tbl_acc.fname, 
                      tbl_acc.mname, tbl_acc.lname, tbl_acc_student.e_verified FROM tbl_acc_student 
                      INNER JOIN tbl_acc ON tbl_acc_student.id = tbl_acc.id 
                      INNER JOIN tbl_section ON tbl_acc_student.section = tbl_section.id
                      WHERE tbl_acc_student.pending = 1 ORDER BY tbl_acc.lname ASC");
                      if(mysqli_num_rows($resulted) > 0) {
                        while($row = mysqli_fetch_assoc($resulted)){
                          ...
                          if($verified == 1){
                              ...
                              $status = "<p style='color:red'>Unverified</p>";
                          }
